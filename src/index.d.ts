...
export declare function computed<T extends NormalSignal>(val: () => T): PrimitiveSignal<T>;

export declare function computed<T extends any[]>(val: () => T): ArraySignal<T>;

export declare function computed<T extends Record<any, any>>(val: () => T): ObjectSignal<T>;
...
export declare function createPromise<T>(fn: () => Promise<T>): ObjectSignal<PromiseOverload<T>>;
 ...
 */
export declare function createSignal<T extends NormalSignal>(val: T): PrimitiveSignal<T>;

export declare function createSignal<T extends any[]>(val: T): ArraySignal<T>;

export declare function createSignal<T extends Record<any, any>>(val: T): ObjectSignal<T>;
...
declare type NormalSignal = boolean | string | number | undefined | null | Error;
...
declare type PropsOf<T extends (...args: any) => any> = Parameters<T> extends [] ? {} : Parameters<T>[0];
...
declare type Type = string | "TEXT_CHILD" | "SIGNAL_CHILD" | "FRAGMENT" | Function;
