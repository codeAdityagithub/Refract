...
export type ComponentChildren = ComponentChild[] | ComponentChild | (() => ComponentChild[] | ComponentChild);
export type Key = string | number | any;
export interface Attributes {
    key?: Key | undefined;
    jsx?: boolean | undefined;
}
export type RenderableProps<P, RefType extends EventTarget = any> = P & Readonly<Attributes & {
...
export declare namespace JSXInternal {
    ...
    export type CommandEventHandler<Target extends EventTarget> = TargetedCommandEvent<Target>;
    ...
    export interface DOMAttributes<Target extends EventTarget> extends RefractDOMAttributes {
